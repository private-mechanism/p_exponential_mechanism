...
from tensorflow_privacy.privacy.dp_query import dp_fixedvariance_query
    ...
    def compute_gradients(self,
      ...
      if callable(loss):
        ...
        if self._unroll_microbatches:
          ...
          idx = tf.constant(0)
          _, sample_state = tf.while_loop(cond=cond_fn, body=body_fn, loop_vars=[idx, sample_state])
...
def make_dp_fixedvarianceoptimizer_class(cls):
  """Constructs a DP optimizer with Gaussian averaging of updates."""

  class DP_fixedvarianceoptimizerClass(make_optimizer_class(cls)):
    """DP subclass of given class cls using Gaussian averaging."""
    ...
    def __init__(
      ...
      super(DP_fixedvarianceoptimizerClass, self).__init__(
          dp_sum_query,
          num_microbatches,
          unroll_microbatches,
          *args,
    ...
    def ledger(self):
      return self._dp_sum_query.ledger
  return DP_fixedvarianceoptimizerClass
...
DP_fixedvarianceoptimizer=make_dp_fixedvarianceoptimizer_class(GradientDescentOptimizer)

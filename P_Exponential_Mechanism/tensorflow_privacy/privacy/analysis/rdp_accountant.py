...
def compute_p_dp_from_ledger(ledger,batchsize,epochs,start_lam,end_lam):
  """Compute RDP of Sampled Gaussian Mechanism from ledger.
    ...
    Returns:
      RDP at all orders, can be np.inf.
    """
  expected_len_ledger=int(ledger[0].population_size*epochs/batchsize)
  if (len(ledger)<expected_len_ledger-10):
    print ('the total privacy guarantee will be printed after the model training！')
    return 0
  else:

...
flags.DEFINE_integer('N', 76343, 'Total number of examples')
flags.DEFINE_integer('batch_size', 500, 'Batch size')
flags.DEFINE_float('noise_multiplier', 0.003, 'Noise multiplier for DP-SGD')
flags.DEFINE_float('epochs', 5000, 'Number of epochs (may be fractional)')
flags.DEFINE_float('delta', 1e-9, 'Target delta')

...
# from tensorflow_privacy.privacy.optimizers import dp_optimizer_general
...
flags.DEFINE_float('noise_variance',16, 'noise_variance')#the noise variance is set as 1/4/16 in our work.
flags.DEFINE_float('exponents',2.0, 'exponents of the p-exponential distribution where the noises are sampled')
  ...
  if mode == tf.estimator.ModeKeys.TRAIN:
      if FLAGS.dpsgd:
          ...
          optimizer = flatten_optimizer.DP_fixedvarianceoptimizer(
              l2_norm_clip=math.sqrt(2 * (FLAGS.data_l2_norm**2 + 1))/4,
